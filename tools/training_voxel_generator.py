...
def run_net(args, config, train_writer=None, val_writer=None):
    ...
    for epoch in range(start_epoch, config.max_epoch + 1):
        ...
        for idx, (data, img, text) in enumerate(train_dataloader):
            num_iter += 1
        ...
        if "validate" in config.keys():
            ...
            inf_config.model.vqgan_config = config.model.vqgan_config
            inf_config.model.voxel_config = config.model.voxel_config
